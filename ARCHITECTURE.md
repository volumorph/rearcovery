...
- Вкладка `guide`: `.guide-wrap` — две колонки (`1fr 360px`): слева `.guide-map` (тулбар, `#graph-canvas`, легенда), справа `.guide-panel` — боковое окно (выбор аккаунта, поиск `#guide-search`, «Проверка безопасности», «Описание и маршрут»). На узких экранах (`<980px`) колонки складываются в одну.
