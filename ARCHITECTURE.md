...
- `screen-main` — единый экран: `.workspace` (`2fr 1fr`) — слева граф, справа `.side-panel` с внутренними вкладками `Аккаунты` / `Путеводитель` (`switchPanel()`); кнопки «Генератор/Экспорт/Импорт/Сменить пароль/Заблокировать» живут в тулбаре графа.
